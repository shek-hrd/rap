...
console.log('🔧 Usage: Click capture buttons to start, then analyze with AI or save/upload');
    toggleRecording() {
        if (this.mediaRecorder && this.mediaRecorder.state !== 'inactive') {
            ...
            this.toggleRecordingBtn.className = 'btn btn-secondary';
        } else {
            this.startRecording();
            this.toggleRecordingBtn.textContent = '?? Stop Recording';
...
console.log('?? Rapture Screen Capture & AI Analysis Tool initialized!');
    ...
    toggleExplanation() {  
        // Placeholder method - explanation toggle functionality  
        console.log('Explanation would be toggled here');  
    }  
